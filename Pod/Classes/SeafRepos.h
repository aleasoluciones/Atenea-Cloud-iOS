...
@interface SeafRepo : SeafDir<SeafSortable,SeafPermissibleProtocol>
...
//- (void)deletedFiles:(NSString *)repoID entry:(SeafBase*)entry block:(void(^)(bool success, id repoInfo))completeBlock;
//- (void)deletedLibraries:(NSString *)repoID block:(void(^)(bool success, id repoInfo))completeBlock;
//-(void) deleteLibrary:(void (^)(BOOL))success;
//- (NSArray *) deletedRepositories;
