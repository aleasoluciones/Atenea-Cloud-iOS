...
/**
 * @brief Represents a filter strategy based on synchronization settings for Seafile.
 */
@interface SyncSettingsFilterStrategy : NSObject<SeafSyncFileProviderFilterStrategy>
