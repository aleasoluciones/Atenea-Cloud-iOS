...
@property (readwrite) BOOL removeSourceAfterUpload;
...
@property (readwrite) NSString *syncId;
@property (readwrite) NSString *syncFileId;
@property (readwrite) BOOL onlyWifi;
