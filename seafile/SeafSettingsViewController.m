...
@interface SeafSettingsViewController ()<CLLocationManagerDelegate>
@property (strong, nonatomic) IBOutlet UITableViewCell *nameCell;
@property (strong, nonatomic) IBOutlet UITableViewCell *planName;
...
@property (weak, nonatomic) IBOutlet UITableViewCell *existingBackupCell;
...
- (void)viewDidLoad
{
    ...
    _planName.textLabel.text = NSLocalizedString(@"Plan contracted", @"Seafile");
    ...
    _existingBackupCell.textLabel.text = NSLocalizedString(@"Existing Backups", @"Seafile");
...
- (void)configureView
{
    ...
    SeafPlanUser *planUser = _connection.getPlan;
    _planName.detailTextLabel.text = planUser.planName;
...
-(void) updateBackupInfo{
    SeafSyncronizer *syncronizer = [SeafSyncronizer sharedInstanceFor:self.connection];
    _existingBackupCell.detailTextLabel.text = [NSString stringWithFormat:@"%lu",(long) [[syncronizer settings] count]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //BACKUP
    if(indexPath.section == SECTION_BACKUPS){
        SeafSyncSettingsViewController *syncSettingsViewController= [[SeafSyncSettingsViewController alloc] initWithConnection:self.connection];
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    NSString *sectionNames[] = {
        ...
        NSLocalizedString(@"Custom backups", @"Seafile"),
