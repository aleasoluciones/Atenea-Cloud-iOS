...
#import "SeafFileFilterFactory.h"
...
- (NSIndexPath *)tableView:(UITableView *)tableView willSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //verify filters
    SeafCompositeFilter *uploadFilter = [SeafFileFilterFactory getProviderPreview:_connection];
...
- (void)popupRenameView:(NSString *)oldName withExtension:(NSString *)extension
{
...
- (void)renameEntry:(SeafBase *)obj
{
    ...
    [self popupRenameView:fileName withExtension:fileExtension];
}
...
- (void)qb_imagePickerController:(QBImagePickerController *)imagePickerController didFinishPickingAssets:(NSArray *)assets {
    ...
    SeafCompositeFilter *uploadFilter = [SeafFileFilterFactory getProviderUpload:_connection];
...
<<<<<<< HEAD
            ...
            SeafAlertChangePlan *alertChangePlan = [[SeafAlertChangePlan alloc] init];
            [alertChangePlan showAlert];

            
=======
            [SeafAlertChangePlan showAlertWithFilterStrategy:failedFilter];
>>>>>>> 3d84431f497c869ace793424c266600f7e82bdd0
            [self dismissImagePickerController:imagePickerController];
            return;
        }
