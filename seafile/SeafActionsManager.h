...
#define S_MKDELETLIB NSLocalizedString(@"Deleted libraries", @"Seafile")
#define S_MKDELETFILE NSLocalizedString(@"Deleted files", @"Seafile")
...
#define S_DELETE_LIB NSLocalizedString(@"Delete library", @"Seafile")
...
#define S_LIB_RENAME NSLocalizedString(@"Rename Library", @"Seafile")
...
#define S_SHARE_PASS NSLocalizedString(@"file_action_share_encrypt", @"Seafile")
